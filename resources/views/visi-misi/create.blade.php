    ...
    <div class="col-12">
        ...
        <div class="card">
            <div class="card-header d-flex">
                ...
                <h4>Buat Visi Misi</h4>
            </div>
            <div class="card-body">
                @if(session('msg')){!! session('msg') !!} @endif
                <form action="{{ url('/visi-misi') }}" method="post" enctype="multipart/form-data">@csrf 
                    <div class="row">
                        <div class="col-md-12">
                            <div class="row mb-3 justify-content-center">
                                ...
                                <div class="col-md-6">
                                    <select name="tentang_kami_id" id="tentang_kami_id" class="custom-select  @error('tentang_kami_id') is-invalid @enderror">
                                        ...
                                        <option value="{{ $o->tentang_kami_id }}" {{ old('tentang_kami_id') == $o->tentang_kami_id ? 'selected' : '' }}>{{ $o->judul }}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="row mb-3 justify-content-center">
                                ...
                                <div class="col-md-6">
                                    <input id="urutan" type="number" min="1" max="1000"
                                        ...
                                        value="{{ old("urutan") }}" autocomplete="urutan"
                                        autofocus>
