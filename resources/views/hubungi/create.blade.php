    ...
    <div class="col-12">
        ...
        <div class="card">
            <div class="card-header d-flex">
                ...
                <h4>Tambahkan Hubungi</h4>
            </div>
            <div class="card-body">
                @if(session('msg')){!! session('msg') !!} @endif
                <form action="{{ url('/hubungi') }}" method="post" enctype="multipart/form-data">@csrf 
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="row mb-3 justify-content-center">
                                ...
                                <div class="col-md-6">
                                    <input id="telepon" type="text"
                                        ...
                                        value="{{ old("telepon") }}" autocomplete="name"
                                        autofocus>
                            ...
                            <div class="row mb-3 justify-content-center">
                                ...
                                <div class="col-md-6">
                                    ...
                                    class="form-control @error('alamat') is-invalid @enderror" name="alamat" cols="30" rows="10">{{ old("alamat") }}</textarea>
