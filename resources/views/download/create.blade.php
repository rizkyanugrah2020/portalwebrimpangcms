    ...
    <div class="col-12">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form action="{{ url('/download') }}" method="post" enctype="multipart/form-data">@csrf 
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="row mb-3 justify-content-center">
                                ...
                                <div class="col-md-6">
                                    <select name="kategori_id" id="kategori_id" class="custom-select  @error('kategori_id') is-invalid @enderror">
                                        ...
                                        <option value="{{ $o->kategori_id }}" {{ old('kategori_id') == $o->kategori_id ? 'selected' : '' }}>{{ $o->nama_kategori }}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="row mb-3 justify-content-center">
                                ...
                                <div class="col-md-6">
                                    ...
                                    class="form-control @error('konten') is-invalid @enderror" name="konten" cols="30" rows="10">{{ old("konten") }}</textarea>
