    ...
    <div class="col-12">
        ...
        <div class="card">
            <div class="card-header d-flex">
                ...
                <h4>Ubah Tentang Kami {{ $tentangKami->judul }}</h4>
            </div>
            <div class="card-body">
                @if(session('msg')){!! session('msg') !!} @endif
                <form action="{{ url('/tentang/' . $tentangKami->tentang_kami_id) }}" method="post" enctype="multipart/form-data">@csrf @method('put')
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="row mb-3 justify-content-center">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <img src="{{ asset('/storage/tentang-kami/' . $tentangKami->gambar) }}" alt="{{ old("nama") }}" class="img img-thumbnail img-temporary" style="width: 800px; height: auto"> 
                                </div>
                            </div>
