    ...
    <div class="col-12">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form action="{{ url('/event') }}" method="post" enctype="multipart/form-data">@csrf 
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="row mb-3 justify-content-center">
                                ...
                                <div class="col-md-6">
                                    <select name="jenis" id="jenis" class="custom-select  @error('jenis') is-invalid @enderror">
                                        ...
                                        <option value="agenda" {{ old('jenis') == 'agenda' ? 'selected' : '' }}>Agenda</option>
                                    </select>
                            ...
                            <div class="row mb-3 justify-content-center">
                                ...
                                <div class="col-md-6">
                                    <input id="prolog" type="text"
                                        ...
                                        value="{{ old("prolog") }}" autocomplete="name"
                                        autofocus>
