    ...
    <div class="col-12">
        ...
        <div class="card">
            <div class="card-header d-flex">
                ...
                <h4>Buat Sosial Media</h4>
            </div>
            <div class="card-body">
                @if(session('msg')){!! session('msg') !!} @endif
                <form action="{{ url('/sosial-media') }}" method="post" enctype="multipart/form-data">@csrf 
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="row mb-3 justify-content-center">
                                ...
                                <div class="col-md-6">
                                    <input id="nama_sosmed" type="text"
                                        ...
                                        value="{{ old("nama_sosmed") }}" autocomplete="name"
                                        autofocus>
                            ...
                            <div class="row mb-3 justify-content-center">
                                ...
                                <div class="col-md-6">
                                    <input id="url" type="text"
                                        ...
                                        value="{{ old("url") }}" autocomplete="name"
                                        autofocus>
