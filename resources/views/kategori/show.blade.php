                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="row mb-3 justify-content-center">
                                ...
                                <div class="col-md-6">
                                    <input readonly id="nama_kategori" type="text"
                            ...
                            <div class="row mb-0">
                                <div class="col-md-6 offset-md-4 d-flex align-items-end">
                                    ...
                                    <a type="button" href="{{ url("/kategori/" . $kategori->kategori_id . '/edit') }}" class="btn mx-2 btn-warning"><i class="fas fa-pen"></i> Ubah</a>
                                    <form action="{{ url("/kategori/" . $kategori->kategori_id) }}" method="POST">@csrf @method('delete')
