                            ...
                            <div class="row mb-3 justify-content-center">
                                ...
                                <div class="col-md-6">
                                    <div class="custom-file">
                                        <input disabled type="file" name="video" class="custom-file-input" id="video" accept="mp4">
                                    ...
                                    <video width="320" height="240" controls>
                                        <source src="{{ asset('/storage/video/file/' . $video->url) }}" type="video/mp4">
                                        <source src="{{ asset('/storage/video/file/' . $video->url) }}" type="video/ogg">
